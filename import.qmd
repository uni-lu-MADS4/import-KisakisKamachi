...
blood_fat <- read_delim("data/blood_fat.csv", delim = ",")
print(blood_fat)
...
# Your answer in code
library(readr)
blood_fat <- read_delim("data/blood_fat.csv", delim = ",", show_col_types = FALSE)

print(blood_fat)
num_rows <- nrow(blood_fat)
cat("Number of rows in the tibble:", num_rows, "\n")
